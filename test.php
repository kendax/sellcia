	...
	<ul class="menu" id="menu">
		<li><div class="user-mobile" style="margin-left:-80px;">
         ...
         <link rel="stylesheet" href="vela.css">
            ...
            <li><a href="index.php" class="active"><img src="https://img.icons8.com/material-outlined/48/000000/home--v2.png" style="max-height:30px; transform:translateY(-50%);"/><span>    </span>Home</a></li>
            ...
            <li><a href="books.php"><img src="https://img.icons8.com/carbon-copy/100/000000/books.png" style="max-height:30px;"/><span>    </span>Books</a></li>
