        ...
        <div id="grid2">
            <div class="slot1">
                <a href="products3/slot1.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows1['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot2">
                <a href="products3/slot8.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows2['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot3">
                <a href="products3/slot10.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows3['Image'];?>" alt="" style="max-height:230px;"></div>
            ...
            <div class="slot4">
                <a href="products3/slot16.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows4['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot5">
                <a href="products2/slot2.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows5['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot6">
                <a href="products2/slot7.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows6['Image'];?>" alt="" style="max-height:230px;"></div>
            ...
            <div class="slot7">
                <a href="products2/slot13.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows7['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot8">
                <a href="products2/slot6.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows8['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot9">
                <a href="products/slot1.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows9['Image'];?>" alt="" style="max-height:230px;"></div>
            ...
            <div class="slot10">
                <a href="products/slot5.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows10['Image'];?>" alt="" style="max-height:230px;"></div>
            ...
            <div class="slot11">
                <a href="products/slot9.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows11['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot12">
                <a href="products/slot12.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows12['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot13">
                <a href="products1/slot2.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows13['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot14">
                <a href="products1/slot6.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows14['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot15">
                <a href="products1/slot9.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows15['Image'];?>" alt="" style="max-height:250px;"></div>
            ...
            <div class="slot16">
                <a href="products/slot16.php" style="color:black;">
                    <div class="img"><img src="http://localhost:8080/uploads/<?php echo $rows16['Image'];?>" alt="" style="max-height:250px;"></div>
