        ...
        <div id="grid">
            <div class="slot1">
                <a href="../products1admin/slot1.php" style="color:black;">
                    ...
                    <input type="submit" value="BUY NOW" style="color:white; background-color:rgb(63, 170, 104); border:none; border-radius:5px; display:block; margin:auto; padding-bottom:none;" border="0" name="submit" alt="">
                </a>
            </div>
            <div class="slot2">
                 <a href="../products1admin/slot1.php" style="color:black;">
